...
const eventDetails = {
    ...
    "DEVIL'S MAP": {
        about: "Follow the clues, claim the crown! Devils Map is a thrilling campus-wide treasure hunt where participants solve riddles and navigate through checkpoints to uncover the final prize.",
        rules: [
