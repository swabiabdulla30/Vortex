...
const eventDetails = {
    "BGMI": {
        ...
        prize: "₹500",
        fee: "₹10 per player",
        about: "<strong>🎮 BGMI Tournament (Erangel Map)</strong><br><br><strong>📌 Tournament Details:</strong><br>Map: Erangel(normal)<br>Mode: Squad (TPP)<br>Total Teams: 25<br>Total Players: 100<br>Registration Fee: ₹10 per player<br>Total Prize Pool: ₹500<br>Duration: 2 Hours",
        rules: [
